...
module.exports={
	...
	// },
	/**
	 * [getData To get master report data]
	 * @param  {[array]}   data     [table -> table name , displayData -> columns list, filtertext-> to add in where condition,
	 * from date , to date -> to compare with order date]
