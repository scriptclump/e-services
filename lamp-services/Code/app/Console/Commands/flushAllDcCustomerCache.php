...
class flushAllDcCustomerCache extends Command {
    ...
    protected $signature = 'flushAllDcCustomerCache {customer_type_id} {product_id} {dc_id} {user_id}';
    ...
    public function handle(){
            ...
            //log::info($arguments);     
            Log::info('All dc/customer flush');
            ...
            DB::unprepared("call ProdSlabFlatRefreshByProductIdByCust($product_id,null,null)");
