...
class EmpAttendanceConsole extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'EmpAttendance';
     ...
     * @var string
     */
    protected $description = 'Schedule Job to take capture Employee Attendance @ 04:00 hrs daily';
    ...
    public function handle()
    {
        ...
        $result = $this->_EmpAtten->indexAction();
