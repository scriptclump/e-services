...
class EmpDetailsConsole extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'EmpDetails';
     ...
     * @var string
     */
    protected $description = 'Copy employee data.. Temp function';
    ...
    {
        parent::__construct();
        $this->_EmpDetails = new EmployeeAttendanceController();
    }
    ...
    public function handle()
    {
        ...
        $result = $this->_EmpDetails->copyEmployeeData();
