...
class DeviceAttendanceConsole extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'DeviceAttendance';
     ...
     * @var string
     */
    protected $description = 'Capture Employee Attendance from Device Log -- daily';
    ...
    public function handle()
    {
        ...
        $result = $this->_EmpAtten->getDeviceAttendance();
