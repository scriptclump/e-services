...
use Utility;
class flushAllCacheDcProducts extends Command {
     ...
     * @var string
     */
    protected $signature = 'flushAllCacheDcProducts {customer_type_id} {appKeyData} {dc_id} {user_id}';
    ...
    public function handle(){
        ...
        Log::info('All products/dc flush is started');
            ...
            DB::unprepared("call ProdSlabFlatRefreshByProductIdByCust(NULL,NULL,$customer_type_id)");
           Utility::sendEmail($toMail, $subject, $body);  
            log::info('done products flush');
