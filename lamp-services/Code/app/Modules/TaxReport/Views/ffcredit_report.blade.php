        ...
        <div class="col-md-12 col-sm-12">
            <div class="portlet light tasks-widget" style="height: auto;">
                <div class="portlet-title">
                    <div class="caption">{{trans('taxReportLabels.ffcredit_heading')}}</div>
                    <div class="tools ">
                        <div class="actions">
                        <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}">
                        <a href="#tag_1" data-toggle="modal" id = "" class="btn btn-success">Export FC Credit Reports</a>
                        </div>      
                        ...
                        `   <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <h4 class="modal-title" id="basicvalCode">Export FC Credit Reports</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form id="bannersExportForm" action="/taxreport/downloadCreditReport" class="text-center" method="POST" onsubmit="return validateform();">
                                        <input type="hidden" name="_token" id = "csrf-token" value="{{ Session::token() }}">
                                        <div class="row">
                                        <!-- <div class="col-md-12" align="center"> -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <option value="Credit Report_1" >Credit Report</option>
                                                <option value="Slab Report_2" >Slab Report</option>
                                                </select>
                                                </div>
                                            </div>
                                        </div>
