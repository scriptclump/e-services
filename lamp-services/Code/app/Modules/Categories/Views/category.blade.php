  ...
  <div class="col-md-12 col-sm-12">
    <div class="portlet light tasks-widget">
      <div class="portlet-title">
        ...
        <div class="actions"> @if(isset($allowed_buttons['add_new_parent_category']) && $allowed_buttons['add_new_parent_category'] == 1) <a href="javascriot:void(0)"  data-toggle="modal" id="addUser" class="btn green-meadow" data-target="#addCategory">Add New Parent Category</a> @endif </div>
      </div>
...
<div class="modal modal-scroll fade" id="addCategory1" tabindex="-1" role="dialog" aria-labelledby="basicvalCode" aria-hidden="true">
  <div class="modal-dialog wide">
    <div class="modal-content">
      ...
      <div class="modal-body"> {{ Form::open(array('url' => 'categories/savecategory', 'class' => 'form1','id'=>'add_category_validation' )) }}
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <label>Parent</label>
              <select class="form-control select2me" name="parent_name" id="category1">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input name="category_image" placeholder="Post image URL here" />
              <br />
        ...
        <div class="row">
          <div class="col-sm-12 text-center"> {{ Form::submit('Add', array('class' => 'btn btn-primary')) }} </div>
        </div>
        {{Form::close()}} </div>
    </div>
    <!-- /.modal-content --> 
...
<div class="modal modal-scroll fade" id="editCategory" tabindex="-1" role="dialog" aria-labelledby="basicvalCode" aria-hidden="true">
  <div class="modal-dialog wide">
    <div class="modal-content">
      ...
      <div class="modal-body"> {{ Form::open(array('url' => 'categories/updatecategory/','data-url' => 'categories/updatecategory/', 'id'=>'update_category_validation' )) }}
...
<div class="modal modal-scroll fade" id="addCategory" tabindex="-1" role="dialog" aria-labelledby="basicvalCode" aria-hidden="true">
  <div class="modal-dialog wide">
    <div class="modal-content">
      ...
      <div class="modal-body"> {{ Form::open(array('url' => 'categories/saveparentcategory', 'class' => 'form1','id'=>'add_parent_validation' )) }}
        {{ Form::hidden('_method','POST') }}
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <select name="status" required class="form-control custom-dropdown__select custom-dropdown__select--white">
                <option  value="1">Active</option>
                <option  value="0">In-Active</option>
              </select>
              </span>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <label>Product Class</label>
              <span class="custom-dropdown custom-dropdown--white"> 
              <select name="is_product_class"  class="form-control custom-dropdown__select custom-dropdown__select--white">
                <option  value="0">No</option>
                <option  value="1">Yes</option>
              </select>
              </span>
