...
<table width="100%" border="0" cellspacing="5" cellpadding="5">
  <tr>
    <td width="50%" align="left" valign="middle"><img src="{{url('/')}}/img/ebutor.png" alt="" height="30" width="30" style="float:left"> <strong style="float:left; line-height:32px; ">{{$leInfo->business_legal_name}}</strong></td>
    <td width="50%" align="right" valign="middle"><div style="padding-left:20px; padding-top:10px; font-size:10px; float:right;">{{$leInfo->address1}} {{(empty($leInfo->address2) ? '' : ','.$leInfo->address2.',')}}<br>
        {{$leInfo->city}}, {{isset($legalEntity->state_name) ? $legalEntity->state_name : ''}}, {{(isset($leInfo->country_name) ? $leInfo->country_name : 'India')}}, {{$leInfo->pincode}} </div></td>
  </tr>
</table>
