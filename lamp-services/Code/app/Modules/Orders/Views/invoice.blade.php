...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12">
      <table cellpadding="1" cellspacing="1" width="100%" class="table table-striped table-bordered table-advance table-hover" style="word-wrap:break-word; white-space:nowrap;font-size:11px;">
        <thead>
          <tr>
...
$taxValue = (int)((($product->single_price*$taxPer)/100) / $product->qty);
$netValue = (int)$product->invoicedQty*$product->single_price;
$discountValue = (int)($product->single_price*$discount)/100;
...
?>
            ...
            <td><p>{{$product->single_price}}</p></td>
