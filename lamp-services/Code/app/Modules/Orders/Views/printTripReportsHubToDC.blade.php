                ...
                <div class="col-md-12">
                    <table width="100%" class="table table-bordered thline printtable " cellpadding="1" style="margin-top:30px;">
                        ...
                        <tr style="font-size:12px;">
                            ...
                            <td>{{ $HubtoDc[$i]['crates_id'] }}</td>
                            <td>{{ $HubtoDc[$i]['order_code'] }}</td>
                            <td>{{ $HubtoDc[$i]['order_status'] }}</td>
                            <td>{{ $HubtoDc[$i]['invoice_code'] }}</td>
                            <td>{{ $HubtoDc[$i]['beat_area'] }}</td>
                            <td>{{ $HubtoDc[$i]['container_value'] }}</td>
                        </tr>
                        <?php
