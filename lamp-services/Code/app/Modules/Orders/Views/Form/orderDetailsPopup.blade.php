<div class="modal modal-scroll fade in" id="orderDetails" tabindex="-1" role="dialog" aria-labelledby="basicvalCode" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="basicvalCode">Order Details</h4>
            </div>
            <div class="modal-body">
                <form id="orderDetailsForm" action="/salesorders/downloadOrderDetails" class="text-center" method="get">
                    <div class="row">
