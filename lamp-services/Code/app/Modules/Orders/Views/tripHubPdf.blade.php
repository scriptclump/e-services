...
<table width="100%" style="border:1px solid #ccc;font-size:10px !important;" cellspacing="0" cellpadding="2">
    ...
    <tr>
        <td valign="top" style="font-size:11px;">
            ...
            <strong>Docket No: </strong>{{ $HubtoDc[0]['rt_docket_no'] }}<br/>
            <strong>Hub Name: </strong>{{ $HubtoDc[0]['hub_name'] }}<br/>
            <strong>Vehicle No: </strong>{{ $HubtoDc[0]['rt_vehicle_no'] }}<br/>
            <strong>Driver Name: </strong>{{ $HubtoDc[0]['rt_driver_name'] }} @if(!empty($HubtoDc[0]['rt_driver_mobile'])) (M: {{ $HubtoDc[0]['rt_driver_mobile'] }})@endif 
        </td>
...
<table cellspacing="0" cellpadding="3" width="100%" style="margin-top:10px; border:1px solid #ccc; font-size:11px;">
    ...
    <tr style="font-weight:bold;">
        ...
        <td bgcolor="#e7ecf1">Order Status</td>
        <td bgcolor="#e7ecf1">Invoice No</th>
    ...
    <tr>
        ...
        <td style="border-bottom:1px solid #ccc;">{{ $HubtoDc[$i]['crates_id'] }}</td>
        <td style="border-bottom:1px solid #ccc;">{{ $HubtoDc[$i]['order_code'] }}</td>
        <td style="border-bottom:1px solid #ccc;">{{ $HubtoDc[$i]['order_status'] }}</td>
        <td style="border-bottom:1px solid #ccc;">{{ $HubtoDc[$i]['invoice_code'] }}</td>
        <td style="border-bottom:1px solid #ccc;">{{ $HubtoDc[$i]['beat_area'] }}</td>
        <td style="border-bottom:1px solid #ccc;">{{ $HubtoDc[$i]['container_value'] }}</td>
    </tr>
    <?php
