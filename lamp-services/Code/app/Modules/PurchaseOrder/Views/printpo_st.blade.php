                ...
                <tr>
                    <td width="50%" align="left" valign="top">
                        <table cellpadding="2" cellspacing="2" class="table" width="100%">
                            ...
                            <tr>
                                <td style="word-wrap:break-word;font-size:11px;width:100%;">* Please Note :</br>
                                1. The aforesaid value mentioned in the delivery challan is only for the purpose of transportation and insurance coverage.</br> 2. These goods are not for sale.</br>
                                2. We will not accept product without MRP and manufacturing date.</td>
                            </tr>
                        </table>
                    </td>
