...
<?php
$url = public_path();
if (isset($historyVal['profile_picture']) && (file_exists($url . $historyVal['profile_picture']) && $historyVal['profile_picture'] != '')) {
...
$master_lookup_name=isset($historyVal['master_lookup_name'])?$historyVal['master_lookup_name']:'';
?>
...
<div class="col-md-3 col-sm-2 push_right">{{$master_lookup_name}}</div> 
