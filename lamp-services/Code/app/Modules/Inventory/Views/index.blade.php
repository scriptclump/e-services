    ...
    <div class="col-md-12 col-sm-12">
        <div class="portlet light tasks-widget" style="height: auto;">
            <div class="portlet-title">
                ...
                <a href="#" data-id="#" data-toggle="modal" data-target="#download-Doc-withalldata" class="btn green-meadow">{{ trans('inventorylabel.gridLevel_3_download_btn') }}</a>
                ...
                <form id="inventory_filters" action="" method="post">	
                    <div id="filters" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3"> 
                                <label><b>{{ trans('inventorylabel.filters.mrp') }}</b></label>
                            ...
                            <div class="col-md-3"> 
                                <label><b>{{ trans('inventorylabel.filters.soh') }}</b></label>
                            ...
                            <div class="col-md-3"> 
                                <label><b>{{ trans('inventorylabel.filters.map') }}</b></label>
                        ...
                        <div class="row">
                            <div class="col-md-3"> 
                                <label><b>{{ trans('inventorylabel.filters.inventory') }}</b></label>
                    ...
                    <b>{{ trans('inventorylabel.filters.enabled_checkbox') }}</b>  <select id="cp_enabled" name="cp_enabled" class="form-control">
                        ...
                        <option value='0'>{{ trans('inventorylabel.filters.select_box_option_no') }}</option>
                            ...
                            <div class="col-md-9 text-right" style="margin-top:20px;">
                                <input type="button" value="{{ trans('inventorylabel.filters.button1') }}" class="btn btn-success" onclick="filterGrid();">
                                                    ...
                                                    <div class="portlet box">
                                                        ...
                                                        <div id='filters'>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                <select name="warehousenamess-replanishment" id="warehousenamess-replanishment" class="form-control" placeholder="{{ trans('inventorylabel.filters.dc') }}" required>
                                                    <option value="">{{ trans('inventorylabel.filters.pop_up_select') }}</option>
                                                    @foreach ($filter_options['dc_name'] as $dc_id => $dc_name)
                                                    <option value="{{ $dc_id }}">{{ $dc_name }}</option>
                                                    @endforeach
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">{{ trans('inventorylabel.gridLevel_3_popup_title') }}</h4>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        
                                                {{ Form::open(array('url' => '#', 'id' => 'download-freebee-data'))}}
...
<div class="col-md-12 text-center"><input type="checkbox" name="freebeechkbox" id="freebeechkbox" value = "yesfreebee"> {{ trans('inventorylabel.gridLevel_3_popup_freebeetext') }}</div>
                                                    ...
                                                    <div class="row">
<div class="col-md-12 text-center butmargtop"><?php  $url = '?filterData={"freebeedata":"NOF001"}'; ?>
                                                    <a href="{{ URL('inventory/getExport'.$url) }}" id="toggleFilter_export" class="btn green-meadow">{{ trans('inventorylabel.filters.export_to_excel') }}</a>
</div>
                                                    </div>
                ...
                <div class="table-scrollable">
                    <table class="inv-title">
                        <tr>
                            <th>{{ trans('inventorylabel.table_header') }}</th>
                        </tr>
                        <tr>
                            <td>
