    ...
    <div class="col-md-12 col-sm-12">
        <div class="portlet light tasks-widget" style="height: auto;">
            <div class="portlet-title">
                <div class="caption">{{ trans('gstReportLabels.hsn_heading_Report') }}</div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <!--Start of filters-->
                <form action="/gstreports/hsnexport" method="POST">
...
<script type="text/javascript">
    ...
    function callTrigger() {
        ...
        $.ajax({
            type: "GET",
            url: "/gstreports/getHsnOutwardReportAction?_token=" + token,
