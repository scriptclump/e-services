    ...
    <div class="col-md-12 col-sm-12">
        <div class="portlet light tasks-widget" style="height: auto;">
            <div class="portlet-title">
                <div class="caption">{{ trans('gstReportLabels.delivered_heading') }}</div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <!--Start of filters-->
                <form action="/gstreports/deliveredhsnreport" method="POST">
...
<script type="text/javascript">
    ...
    function callTrigger() {
        ...
        $.ajax({
            type: "GET",
            url: "/gstreports/deliveredhsnreport?_token=" + token,
