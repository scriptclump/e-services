...
class PIMAllProductDownloadController extends BaseController {
    ...
    public function downloadAllProductInfo($userId,$leid='') {
        ...
        try{
           // ini_set('max_execution_time', 1200);
            ...
            $data = $ProductModelObj->downloadAllProductInfo($leid);
            ...
            echo $this->mailExcelReport($path_name,$userId);
    ...
    public function QueueDownloadAllProductInfo(){
        try{
            ...
            //Log::info("Calling PIMAllProductDownloadController Download all product info with queue.....user id...".$userid);
            $this->queue = new Queue();
            $args = array("ConsoleClass" => 'AllPIMDownloadReport', 'arguments' => array("data"=>$userid));
            //Log::info(print_r($args,true));
            $this->queue->enqueue('default', 'ResqueJobRiver', $args);
            return "Please check your mail, find attached ALL Products Report.";
