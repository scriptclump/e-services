<div id="gridSection">
    <div class="row">
        <div class="col-md-12">
            <strong>Assign Item to the Promotion</strong> <span id="no_product_span" style ="color:red"></span><!-- <button type="button" onclick="getItemGrid();" class="btn green-meadow">Get <span id="item_text">Item</span></button> -->
            <hr/>
        </div>
    </div>
    <div class="row">
