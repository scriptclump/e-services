      ...
      <div class="portlet-title">
        ...
        <div class="tab-pane" id="tab_22">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="control-label">PAN Card Number  <span data-original-title="Tooltip in top" data-placement="top" class="badge bg-blue tooltips"><i class="fa fa-question"></i></span> </label>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="control-label">CIN Number <span data-original-title="Tooltip in top" data-placement="top" class="badge bg-blue tooltips"><i class="fa fa-question"></i></span></label>
                    </div>
                ...
                <div class="row VAT">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="control-label">TIN/VAT Number <span data-original-title="Tooltip in top" data-placement="top" class="badge bg-blue tooltips"><i class="fa fa-question"></i></span></label>
                    </div>
                ...
                <div class="row CST">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="control-label">CST Number  <span data-original-title="Tooltip in top" data-placement="top" class="badge bg-blue tooltips"><i class="fa fa-question"></i></span></label>
                    </div>
