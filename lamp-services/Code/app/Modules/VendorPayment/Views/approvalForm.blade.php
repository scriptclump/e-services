...
<input type="hidden" name="request_id" id="request_id" value="{{ $poDetail->request_id  }}"/>
...
<div class="row margbott">
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <input type="text" id="approved_amount" name="approved_amount" value="{{ $poDetail->requested_amount  }}" class="form-control" />
        </div>
        <div class="form-group">
