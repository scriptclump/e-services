<?php
    ...
    class PieChart extends Chart {
        ...
        protected function computeLayout() {
            ...
            $this->pieWidth = round(($graphArea->x2 - $graphArea->x1) * 3 / 5);
            $this->pieHeight = round(($graphArea->y2 - $graphArea->y1) * 3 / 5);
        ...
        protected function drawPercent() {
            ...
            foreach ($this->percent as $a) {
                ...
                $x = cos($angle) * ($this->pieWidth + 30) / 2 + $this->pieCenterX;
                $y = sin($angle) * ($this->pieHeight + 30) / 2 + $this->pieCenterY;
